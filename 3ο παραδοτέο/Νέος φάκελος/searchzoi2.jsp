...
<%
Apartmentzoi ap = new Apartmentzoi(122, "Marias Apartment", "4/1/24", "6/1/24","Kato Patisia", "Athens 234", 150, 1, "okay", 1,0, 1111);
List<Apartmentzoi> receivedList = ap.createApartmentList();;
            ...
            <div class="list-container">
                <div class="left-col">
                    ...
                    <h1>Recommended Places In </h1> 
						...
						<% for (Apartmentzoi apart1: receivedList) { %>
                            <form action="apartment_final.jsp" method="post">
                                ...
                                <input type="hidden" name="price" value="<%=apart1.getPrice()%>">
