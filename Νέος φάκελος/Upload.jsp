            ...
            <%if (session.getAttribute("authenticated_user")!=null){
                ...
                int user_id=user.getId();
                  ...
                  <% if(request.getAttribute("error") != null) { %>		
                    <div class="alert1 alert-success text-center" role="alert"><%=(String)request.getAttribute("error") %></div>
                <% } %>
            </div>
            
            <center><form action="UploadApartmentController.jsp" method="get" class="upload-form" style="top: 50%;">
