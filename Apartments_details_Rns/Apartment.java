...
public class Apartment {
    ...
    private boolean up_rent;
    private boolean up_swap;
    private int user_id;
    ...
    public Apartment(int apartment_id, String name, String available_from, String available_until, 
                String city, String address, float price, int capacity, String features, boolean up_rent,boolean up_swap, int user_id) {        
        this.name = name;
    ...
    public void setUpRent(boolean up_rent) {
        this.up_rent = up_rent;
    }
    public boolean getUpRent() {
        return up_rent;
    }
    public void setUpSwap(boolean up_swap) {
        this.up_swap = up_swap;
    }
