...
public class Swap {
    ...
    public void swap_apart(int user_id,int apartment_id,String name,String option_apart) throws Exception{
        //name:the name of the apartment that the user wants
        //apartment_n:the name of the user's apartment that he/she wants to swap
        DB db = new DB();
        Connection con = null;
        String query= "INSERT INTO swap (user_id,apartment_id,name,option_apart) VALUES (?, ?, ?, ?);";
