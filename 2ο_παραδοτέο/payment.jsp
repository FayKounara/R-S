...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/8210066/css/bootstrap-theme.min.css">
</head>
    <div class="content">
        <nav>
            <ul>
    ...
    %>
            ...
            <fieldset align=center>
                ...
                <div class="label-input-pair">
                    <label for="fname" class="inline">Name: </label>
                    <input type="text" id="fname" name="fname">
                    <label for="lname" class="inline"> Surname:</label>
                ...
                <div class="label-input-pair">
                    ...
                    <label><h4>Choose your payment method:</h4></label>
                    <ul>
                        <input type="radio" id="cash" name="options" value="option1" checked>Card
                        <input type="radio" id="card" name="options" value="option2">Cash
                    </ul>
                <div class="label-input-pair">
                ...
                <div class="label-input-pair">
                    ...
                    <label for="expire" class="inline"> Exp.Date:</label>
